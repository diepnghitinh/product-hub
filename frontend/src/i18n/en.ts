...
export const en = {
  ...
  'docs.makeVisible': 'Make visible to workspace',
  'docs.private': 'Private',
  'docs.privateBadgeHint': 'Only you and admins can see this doc.',
  'docs.privateShareBlocked': 'Make the doc visible to the workspace before sharing it.',
  'docs.confirmMakePrivate':
    'Make this doc private? Only you and admins will be able to see it, and its public link will stop working.',
  'docs.madePrivate': 'This doc is now private.',
  'docs.madeVisible': 'This doc is visible to the workspace again.',
  ...
  // bet it belongs to.
  'roadmaps.epic': 'Epic',
  'roadmaps.epics': 'Epics',
  'roadmaps.noEpic': 'No epic',
  'roadmaps.manageEpics': 'Manage epics',
  'roadmaps.newEpic': 'New epic',
  'roadmaps.addEpic': 'Add epic',
  'roadmaps.epicName': 'Epic name',
  'roadmaps.epicColor': 'Epic color',
  'roadmaps.epicDescription': 'What is this bet? (optional)',
  'roadmaps.epicsHint':
  ...
  'roadmaps.moveEpicItemsTo': 'Move items to',
  'roadmaps.leaveUngrouped': 'Leave them ungrouped',
  ...
  'uploads.addFile': 'Add file',
  'uploads.removeFile': 'Remove file',
  'uploads.filesHint': 'or drop PDF, Word or Excel files here',
  'uploads.queued': 'Waiting',
  'uploads.finishing': 'Finishing…',
  'uploads.cancelUpload': 'Cancel upload',
  'uploads.tooMany': 'Up to {n} files on one item — the rest were not added.',
  'uploads.files': 'Files',
  'uploads.download': 'Download',
  'uploads.preview': 'Preview',
  'uploads.previewLoading': 'Opening file…',
  'uploads.previewFailed': 'This file could not be opened.',
  'uploads.previewUnsupported': 'There is no preview for this file type yet.',
  'uploads.previewDownloadHint': 'Download it to open in Word, PowerPoint or another app.',
  'uploads.previewEmptySheet': 'This sheet is empty.',
